...
// test("checks sidebar for customer", async () => {
//     // Mock implementation for useAuth
//     useAuthMock.mockImplementation(() => ({
//         currentUser: {
//             id: 'mocked-user-id',
...
// test("checks sidebar for admin", async () => {
//     // Mock implementation for useAuth
//     useAuthMock.mockImplementation(() => ({
//         currentUser: {
//             id: 'mocked-user-id',
...
// test("check all the links for customer", async () => {
//      // Mock implementation for useAuth
//      useAuthMock.mockImplementation(() => ({
//         currentUser: {
//             id: 'mocked-user-id',
...
// test("check all the links for admin", async () => {
//     // Mock implementation for useAuth
//     useAuthMock.mockImplementation(() => ({
//        currentUser: {
//            id: 'mocked-user-id',
...
// test("checks sidebar for volunteer", async () => {
//     // Mock implementation for useAuth
//     useAuthMock.mockImplementation(() => ({
//         currentUser: {
//             id: 'mocked-user-id',
...
// test("check all the links for volunteer", async () => {
//     // Mock implementation for useAuth
//     useAuthMock.mockImplementation(() => ({
//        currentUser: {
//            id: 'mocked-user-id',
