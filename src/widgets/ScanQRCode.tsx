...
const ScanQRCode = ({mode, DishID, setDishID, PopUp, setPopUp, ShowQRScanner, setShowQRScanner, onScan}) => {
    ...
    <div className={`scanner-main ${ShowQRScanner ? "" : "hidden"}`}>
      <div className="scanner-wrapper">
        ...
        <div style={{ height: "100vh", width: "80%", display: (ShowQRScanner ? "block" : "none") }}>
          ...
          <QRCanvas setFacingMode={setFacingMode} FacingMode={FacingMode} setDishID={setDishID} onScan={onScan} />
